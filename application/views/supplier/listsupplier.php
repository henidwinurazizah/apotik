...
<div class="span12">
 <a style="margin-bottom:5px;" href="<?php echo base_url() ?>supplier/form/" class="dark_green btn">Tambah Data Supplier</a>
											<div class="well grey">
 ...
 <table class="table multimedia table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
											...
											<span class="label label-warning"><?php echo $row->id_supplier ?></span>
											</td>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a class="btn" href="<?php echo base_url().'supplier/form/'.$row->id ?>">
