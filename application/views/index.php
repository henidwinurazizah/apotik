...
<div id="infodlg" style="display:none"></div> 
    <header class="dark_grey"> <!-- Header start -->
        <a href="#" class="logo_image"><span class="hidden-480">-DEV-</span></a>
    ...
    <div id="main_navigation" class="dark_grey"> <!-- Main navigation start -->
        <div class="inner_navigation">
            <ul class="main">
                <li><a href="#"><i class="icon-tasks"></i><b>APOTIK</b></a></li>
                <li><a href="<?php echo base_url() ?>jual"><i class="icon-tasks"></i>Penjualan</a></li>
                <li><a href="<?php echo base_url() ?>beli"><i class="icon-tasks"></i>Pembelian</a></li>
                <li><a href="#"><i class="icon-tasks"></i><b>MASTER</b></a></li>
                <li><a href="<?php echo base_url() ?>barang/listbarang"><i class="icon-tasks"></i>Barang</a></li>
                <li><a href="<?php echo base_url() ?>supplier/listsupplier"><i class="icon-tasks"></i>Suplier</a></li>
                <li><a href="<?php echo base_url() ?>customer/listCustomer"><i class="icon-tasks"></i>Customer</a></li>
                <li><a href="<?php echo base_url() ?>laporan/listLaporanBeli"><i class="icon-tasks"></i>Laporan Pembelian</a></li>
                <li><a href="<?php echo base_url() ?>laporan/listLaporanJual"><i class="icon-tasks"></i>Laporan Penjualan</a></li>
                <li><a href="<?php echo base_url() ?>kategori/listKategori"><i class="icon-tasks"></i>Kategori</a></li>
                <li><a href="<?php echo base_url() ?>satuan/listSatuan"><i class="icon-tasks"></i>Satuan</a></li>
               <?php if($this->session->userdata('STATUS')==0) {?><li><a href="<?php echo base_url() ?>user"><i class="icon-signal"></i>User</a></li> <?php } ?>
			</ul>
        </div>
    </div>
